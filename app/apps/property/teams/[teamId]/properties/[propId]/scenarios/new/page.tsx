...
interface TeamNewScenarioPageProps {
  params: Promise<{ teamId: string; propId: string }>
}

export default async function TeamNewScenarioPage({ params }: TeamNewScenarioPageProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          <h2 className="mb-6 text-2xl font-bold text-gray-900">Add New Scenario (Team)</h2>
          <ScenarioForm
